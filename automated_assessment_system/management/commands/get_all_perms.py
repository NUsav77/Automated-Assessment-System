"""
Tells us the permissions registered in the app.
see https://timonweb.com/django/how-to-get-a-list-of-all-user-permissions-available-in-django-based-project/
and
